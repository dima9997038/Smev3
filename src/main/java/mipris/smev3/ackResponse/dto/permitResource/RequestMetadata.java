...
public class RequestMetadata {
    ...
    @XmlElement(name = "clientId", namespace = "urn://x-artefacts-smev-gov-ru/services/service-adapter/types")
    private String clientId;

    @XmlElement(name = "replyToClientId", namespace = "urn://x-artefacts-smev-gov-ru/services/service-adapter/types")
